  ...
  const projects = [
    {
        id:1,
        title:"Project 1",
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cum necessitatibus explicabo exercitationem reiciendis architecto est. Ratione ullam blanditiis eveniet.",
    ...
    <section id="projects" className="py-24 px-4 relative">
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="text-center mt-12">
                <a className="cosmic-button w-fit flex items-center mx-auto gap-2" href="https://github.com/tusharRao12" target="_blank">Check My Github <ArrowRight/></a>
            </div>
        </div>
    </section>
  )
